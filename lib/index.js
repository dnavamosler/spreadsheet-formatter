...
class spredSheetFormatter {
    ...
    createJWT() {
        ...
        var token = jwt.sign(payload, __classPrivateFieldGet(this, _spredSheetFormatter_secret, "f"), { algorithm: 'RS256' });
        const oAuthPayload = {
    ...
    getPageSpreadSheet(spreadSheetId, pageTitle, pageId, asObject = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    values.forEach(([title, description], index) => {
                        if (title) {
                            if (asObject) {
                                metaDataObject = Object.assign(Object.assign({}, metaDataObject), { [title.toLowerCase().split(' ').join('-')]: description });
                            }
                            else {
                                const haveError = (description === null || description === void 0 ? void 0 : description.search('#REF!')) === 0 || !description
                                    ? true
                                    : false;
                                const errorMessage = `Error in: https://docs.google.com/spreadsheets/d/${spreadSheetId}/edit#gid=${pageId} in row ${index + 1}`;
                                if (haveError) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const metaData = yield this.getPageSpreadSheet(spreadSheetId, title, metadataId);
